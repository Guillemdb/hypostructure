...
nontriviality condition in Proposition~\ref{paper5:prop:selected-window-suitable-estimates}, after
...
\begin{enumerate}[label=(\roman*)]
  ...
  Proposition~\ref{paper5:prop:selected-window-suitable-estimates} fail on the selected windows.
\end{enumerate}
\end{theorem}
...
Proposition~\ref{paper5:prop:selected-window-suitable-estimates}, or the branch lies in the compactness alternative.  If
...
the selected-core retention of \cref{paper5:thm:core-retention} read on the
same canonical terminal windows; if it fails, the lower active-core row has
failed and the branch is in \textup{(A1)}.  This proves the dichotomy.
\end{proof}
