...
Terminal nonactive or nonconcentrating state & Terminal extraction produces no active compact concentration. & Routed to terminal nonactive discharge; retained mass cannot disappear. & \path|thm:terminal-nonactive-exclusion|. \\
...
\node[archnode, below=of R6a] (R6b) {No nonactive/diffuse/mixed alternatives: \path|thm:terminal-nonactive-exclusion|, \path|thm:no-mixed-compact-diffuse|};
...
\node[archnode, left=of TC1, xshift=-35mm] (NON) {Nonactive/diffuse/mixed alternatives: \path|thm:terminal-nonactive-exclusion|, \path|thm:diffuse-defect-compactness|, \path|thm:recurrent-diffuse-defect-measure|, \path|thm:diffuse-defect-trichotomy|, \path|thm:no-mixed-compact-diffuse|.};
...
Terminal nonactive, diffuse, or mixed branch to closure & One must verify whether retained mass is absent, diffuse, mixed compact-diffuse, or compact active. & \path|thm:terminal-nonactive-exclusion|, \path|thm:diffuse-defect-trichotomy|, and \path|thm:no-mixed-compact-diffuse| close the noncompact alternatives or reroute them. \\
...
thm:terminal-nonactive-exclusion\\
