...
\(c_{\rm sl}(\calK_{\rm ext},\alpha_0)\) be the corresponding compact-state
constant from \Cref{lem:timeslice-to-ckn-activity}, as used in
...
\[
   4\eta_*<c_{\rm sl}(\calK_{\rm ext},\alpha_0).
\]
...
\(m_n^{\rm vel}<4\eta_*<c_{\rm sl}(\calK_{\rm ext},\alpha_0)\).
