...
All arguments are local in spacetime.  Apart from the standard
Caffarelli--Kohn--Nirenberg \(\varepsilon\)-regularity theorem, all quantities
and alternatives used in the argument are defined below.
