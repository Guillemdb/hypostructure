...
The Type I blow-up input used in the chain produces, after parabolic rescaling
around a Type I singular point, a nonzero ancient solution \((U,P)\) of
...
\subsection{Relation to the Type I chain}

The Type I reduction supplies nonzero ancient limits satisfying
\eqref{eq:typeI}.  Uniformly \(L^3\)-tight ancient solutions are treated by a
separate tight-class argument.  The present paper records the unconditional
symmetry and perturbative weighted-vorticity exclusions used by the chain.
Known Liouville theorems rule out the axisymmetric cases listed above, and the
Lyapunov argument handles the perturbative weighted-vorticity case.  This
paper does not depend on the tight-class argument.
