...
\begin{remark}
Under the same global \(L^\infty_tL^3_x\) assumption, Type I blow-up is
already excluded by the theorem of Escauriaza--Seregin--Sverak
\cite{ESS2003}.  The proposition is included only to record the scaling of
the critical norm.
\end{remark}
