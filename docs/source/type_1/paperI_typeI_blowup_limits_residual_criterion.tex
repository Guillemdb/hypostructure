...
{DuranPaperII}.  Paper II applies the physical pullback and the
Albritton--Barker endpoint ancient Liouville theorem to uniformly
\(L^3\)-tight centered ancient profiles carrying the Paper I compact velocity
normalization.
\end{proof}
