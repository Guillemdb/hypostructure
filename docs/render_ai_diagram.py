#!/usr/bin/env python3
"""Render the AI/ML Research diagram HTML to a single-page PDF using Playwright."""
...
async def render_to_pdf():
    html_path = Path(__file__).parent / "ai_diagram_standalone.html"
    svg_path = Path(__file__).parent / "ai_diagram.svg"
    png_path = Path(__file__).parent / "ai_diagram.png"
